...
const btnCriptografar = document.querySelector("#btn-cripto");
const btnDescriptografar = document.querySelector("#btn-descripto");
...
document.getElementById('btn-cripto').onclick = (e) => {
  e.preventDefault();
...
document.getElementById('btn-descripto').onclick = (e) => {
  e.preventDefault();
